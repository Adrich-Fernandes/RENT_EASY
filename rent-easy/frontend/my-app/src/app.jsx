        ...
        <div className="">
            <nav className="w-full h-16  z-50 shadow-md px-8 flex items-center justify-between">
                ...
                <div className="flex items-center gap-6">
                    ...
                    {/* Sign Up Button */}
                    <button className="px-6 py-2 font-bold text-white bg-green-600 rounded-xl shadow-[0_0_20px_rgba(34,197,94,0.6)] hover:bg-green-700 hover:shadow-[0_0_30px_rgba(34,197,94,0.8)] transition-all duration-300">
                        Sign Up
                    </button>
