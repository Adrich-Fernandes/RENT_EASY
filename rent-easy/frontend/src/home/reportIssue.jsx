        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            <motion.div 
              ...
              className="inline-flex items-center gap-2 bg-[#1D3557]/10 text-[#1D3557] px-4 py-2 rounded-full font-bold text-xs uppercase tracking-widest mb-4"
            >
              <AlertCircle size={14} />
              Support Center
            </motion.div>
            ...
            >
              Report an <span className="text-[#1D3557]">Issue</span>
            </motion.h1>
            <motion.p 
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
            ...
            <div className="lg:col-span-1 space-y-8">
              <div className="bg-gray-50 p-6 rounded-3xl border border-gray-100">
                <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                  <ShieldCheck size={20} className="text-[#1D3557]" />
                  Our Guarantee
                </h3>
                ...
                {success ? (
                  ...
                  >
                    <div className="w-20 h-20 bg-[#F1FAEE] rounded-full flex items-center justify-center mx-auto mb-6">
                      <CheckCircle2 size={40} className="text-[#1D3557]" />
                    </div>
                    ...
                    <div className="flex justify-center">
                      <div className="w-12 h-1 bg-[#F1FAEE] rounded-full overflow-hidden">
                        <motion.div 
                          ...
                          className="w-full h-full bg-[#1D3557]"
                        />
                      </div>
                    </div>
                  </motion.div>
                  ...
                  >
                    <div className="absolute top-0 right-0 w-32 h-32 bg-[#1D3557]/5 rounded-bl-full -z-10 opacity-50"></div>
                    ...
                    <div className="space-y-6">
                      ...
                      <button 
                        type="submit"
                        disabled={loading}
                        className="w-full bg-[#1D3557] hover:bg-[#457B9D] text-white font-bold py-5 rounded-2xl shadow-lg shadow-[#1D3557]/20 transition-all flex items-center justify-center gap-2 group disabled:bg-gray-400 active:scale-95"
                      >
                        {loading ? (
