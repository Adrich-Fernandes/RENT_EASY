                    ...
                    >
                      ...
                      <td className="px-5 py-4" onClick={(e) => e.stopPropagation()}>
                        <input
                          ...
                          className={`border rounded-lg px-2 py-1 text-sm focus:outline-none focus:ring-2 ${title.includes("Returns") ? "focus:ring-orange-400 border-orange-200" : "focus:ring-[#1D3557] border-gray-300"}`}
                        />
                      </td>
                      <td className="px-5 py-4">
                        <span className={`px-2 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider ${order.paymentType === "Online" ? "bg-[#1D3557]/10 text-[#1D3557]" : "bg-blue-100 text-blue-700"}`}>
                          {order.paymentType || "—"}
                        </span>
                      </td>
                      <td className="px-5 py-4">
    ...
    <>
      ...
      <div className="p-4 md:p-6 w-full">
        ...
        <div className="flex flex-wrap items-center gap-3 mb-8 bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
          <div className="relative flex-1 min-w-[260px] flex rounded-lg border border-gray-300 overflow-visible focus-within:ring-2 focus-within:ring-[#1D3557] focus-within:border-transparent bg-white">
                ...
                <div className="absolute left-0 top-full mt-1 w-36 bg-white border border-gray-200 rounded-xl shadow-xl z-50 overflow-hidden">
                  {SEARCH_FIELDS.map((f) => (
                    <button
                      ...
                      className={`flex items-center gap-2 w-full text-left px-4 py-2.5 text-sm transition hover:bg-gray-50 ${searchField === f.value ? "font-bold text-[#1D3557]" : "text-gray-700"}`}
                    >
                      {f.label}
                    </button>
                  ))}
          ...
          {(() => {
            ...
            return options.map((option) => (
              <button
                ...
                className={`flex items-center gap-2 w-full text-left px-4 py-2.5 text-sm hover:bg-gray-50 capitalize transition ${order.status === option ? "font-bold text-[#1D3557]" : "text-gray-700"}`}
              >
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex items-center gap-4 bg-gray-50 rounded-xl p-4">
            ...
            <div>
              ...
              <p className="text-[#1D3557] font-semibold">₹{order.price} / month</p>
          ...
          {(order.cancelReason || order.returnReason) && (
            <div className={`p-4 rounded-xl border ${order.cancelReason ? "bg-[#F1FAEE] border-[#457B9D]/30" : "bg-orange-50 border-orange-100"}`}>
              <p className={`text-xs font-bold uppercase tracking-widest mb-1 ${order.cancelReason ? "text-[#1D3557]" : "text-orange-400"}`}>
                {order.cancelReason ? "Cancellation Reason" : "Return Reason"}
              </p>
              <p className={`text-sm font-medium ${order.cancelReason ? "text-[#1D3557]" : "text-orange-700"}`}>
                {order.cancelReason || order.returnReason}
              </p>
            </div>
          )}
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-3 text-sm">
              <div className="bg-gray-50 rounded-lg p-3">
                ...
                <p className="font-bold text-[#1D3557] text-lg">₹{order.price}</p>
              </div>
              <div className="bg-gray-50 rounded-lg p-3">
              ...
              <div className="bg-gray-50 rounded-lg p-3 col-span-2">
                ...
                <p className={`font-bold ${order.paymentType === "Online" ? "text-[#1D3557]" : "text-blue-600"}`}>{order.paymentType || "—"}</p>
              </div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3">
                <input
                  ...
                  className="flex-1 border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#1D3557]"
                />
                <button
                  onClick={() => localDate && onDateChange(order._id, localDate)}
                  className="px-4 py-2 bg-[#1D3557] hover:bg-[#457B9D] text-white text-sm font-semibold rounded-lg transition"
                >
                  Save
                </button>
              </div>
