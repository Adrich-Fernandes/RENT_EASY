      ...
      <div className="p-6 md:p-8 bg-gray-50/50 min-h-screen">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
            <div>
              <h1 className="text-3xl font-extrabold text-gray-900">User <span className="text-red-600">Issues</span></h1>
            ...
            <div className="flex flex-wrap items-center gap-4">
              <div className="relative">
                ...
                <input 
                  ...
                  className="pl-10 pr-4 py-2.5 bg-white border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-red-400/20 w-64 shadow-sm"
                />
              </div>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <h3 className="font-bold text-gray-900 truncate group-hover:text-red-600 transition-colors uppercase">{iss.subject}</h3>
                    ...
                    <div className="p-6 space-y-6">
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full p-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-2 focus:ring-red-400/20 text-sm min-h-[120px] resize-none"
                        />
                        ...
                        <div className="flex gap-3 mt-4">
                           <button
                             ...
                             className="flex-1 bg-red-600 hover:bg-red-700 disabled:bg-gray-300 text-white font-bold py-3 rounded-xl flex items-center justify-center gap-2 text-sm transition-all"
                           >
                           ...
                           <button
                             ...
                             className="p-3 bg-gray-100 hover:bg-red-50 hover:text-red-600 rounded-xl text-gray-400 transition-all"
                           >
                             <Trash2 size={18} />
                           </button>
                        </div>
