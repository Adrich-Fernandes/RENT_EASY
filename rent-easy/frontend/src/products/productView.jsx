          ...
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="lg:w-1/2 space-y-5">
              <div className="flex gap-2 flex-wrap">
                <span className="bg-[#A8DADC]/30 text-[#457B9D] px-3 py-1 rounded-full text-sm font-medium">{product.category}</span>
                {product.subcategory && (
                  <span className="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-sm font-medium">{product.subcategory}</span>
                )}
                <span className={`px-3 py-1 rounded-full text-sm font-medium ${product.available ? "bg-[#A8DADC]/30 text-[#457B9D]" : "bg-red-100 text-red-500"}`}>
              ...
              {cartStatus === "done" && (
                <button onClick={() => navigate("/cart")} className="w-full py-3 rounded-xl border-2 border-[#457B9D] text-[#457B9D] font-semibold hover:bg-[#F1FAEE] transition text-sm">
                  Go to Cart →
                </button>
              )}
